...
const themeDefinitions = [
  ...
  },
  {
    ...
    type: 'light',
    // Rich Warm Parchment & Espresso (Lighter Canvas)
    bg: '#FCFAF6',
    bgSubtle: '#F6F0E7',
    bgSidebar: '#F3EDE2',
  ...
  },
  {
    ...
    type: 'light',
    // Restorative Forest & Sage (Lighter Canvas)
    bg: '#F8FCF9',
    bgSubtle: '#EDF6F0',
    bgSidebar: '#E8F2EB',
  ...
  },
  {
    ...
    type: 'light',
    // Warm Solar Ochre & Sandstone (Lighter Canvas)
    bg: '#FCFAF4',
    bgSubtle: '#F6F2E3',
    bgSidebar: '#F2EDDC',
  ...
  },
  {
    ...
    type: 'light',
    // Spiced Linen & Terracotta (Lighter Canvas)
    bg: '#FCF8F4',
    bgSubtle: '#F6ECE4',
    bgSidebar: '#F3E7DC',
