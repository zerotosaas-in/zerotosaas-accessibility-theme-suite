...
2. **Across Enterprise SaaS Web Applications**:
   ...
   - Pre-generated **design tokens** (CSS, Tailwind v3/v4, Figma/Style Dictionary) and **terminal color schemes** (iTerm2, Terminal.app, Windows Terminal, Alacritty, Kitty, Ghostty, Warp) ship with every release — see [🎨 Cross-Platform: Terminals, Design Tokens & Web Frameworks](#-cross-platform-terminals-design-tokens--web-frameworks) below.
...
> **Note**: `.terminal` files contain binary NSKeyedArchiver color blobs and require macOS `plutil` to generate. They are validated with `plutil -lint` during the build.
